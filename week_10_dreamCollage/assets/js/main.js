$(document).ready(function(){
	...
	//TO DO
		...
		//Add background images...or a div that will fade in as "bodyFade" fades out?
		//Add instructions
			//Either: an alert on page load
			//Or if the user doesn't move their mouse for ~3 seconds, show a div in the top right corner or something
		 //Create an option for the user to delete the image
		 //Create an option for the user to reset the page (clear the cookies)
