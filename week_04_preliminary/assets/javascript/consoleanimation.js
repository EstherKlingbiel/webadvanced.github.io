/*HERE IS WHAT I WANT TO DO:
	...
	2. Each line of the animation, depending on the word, has a set number of characters in the following formats:
			...
			Letter(s)-emoji(s);
			Emoji(s)-letter(s);
		I need to figure out how to code this, so that, using the following above example, for the first three lines the animation would happen like such:
			...
			line 3: 36-emojis-3 letters (S, E, S)-1 emoji
				...
				Problem 2: The emojis do not degrade or build by 1 each time; sometimes they degrade/build by 2; sometimes they do not change. I need to 	account for this in my code. Refer to above example for clarity. 

	3. Beyond this, I really have no clue where to even begin.
		-I know I have to shuffle the emoji array, but still give it instructions on how many (and where) emojis should be on each line
		-I know I have to somehow add non-randomized letters into the middle or sides of my randomized emojis
		-I know I have to put all of this stuff in a for loop animation. I was playing with nesting for loops and was able to call the two arrays side-by-side, but not randomize them or repeat the emojis on the line OR after they have completed one loop (they return as undefined when their loop runs out, then for some reason i get five NaNs at the end of the loop). The following is this half-finished loop. You can see what I'm talking about if you run it in the console.

		My biggest issue still remains to be the Javascript syntax. I can't find any examples online that show how I would code or combine these steps. 
